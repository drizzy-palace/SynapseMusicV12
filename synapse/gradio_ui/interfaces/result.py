"""
Synapse Music V12 - Gradio UI Results Section

Contains the Synapse Music results display, generated-song controls,
Composer metadata state, quality analysis, lyric timing, generation
history, and batch result components.
"""
...
def create_results_section(dit_handler) -> dict:
    """
    Create the Synapse Music V12 results display section.

    Args:
        dit_handler:
            Synapse Music generation handler instance.

    Returns:
        dict:
            Dictionary containing all result components and generation states.
    """
    ...
    with gr.Accordion(
        ...
        # =====================================================================
        # Synapse Composer / Generation State
        # =====================================================================

        # Hidden state containing metadata generated by Synapse Composer.
        composer_metadata_state = gr.State(
            value=None
        )

        # Tracks whether the current music style / metadata came from a
        # formatted source such as Synapse Composer or transcription.
        is_format_caption_state = gr.State(
            value=False
        )
        ...
        # Currently displayed generation batch.
        current_batch_index = gr.State(
            value=0
        )

        # Total number of generated batches.
        total_batches = gr.State(
            value=1
        )

        # Stores generated batch data.
        batch_queue = gr.State(
            value={}
        )

        # Stores generation parameters used for subsequent batches.
        generation_params_state = gr.State(
            value={}
        )

        # Tracks background generation state.
        is_generating_background = gr.State(
            value=False
        )
        ...
        with gr.Row():
            ...
            with gr.Column(
                ...
                with gr.Accordion(
                    t(
                        "results.details_accordion"
                    ),
                    open=False,
                    visible=True,
                ) as details_accordion_1:

                    score_display_1 = gr.Textbox(
                        label=t(
                            "results.quality_score_label",
                            n=1,
                        ),
                        interactive=False,
                        buttons=["copy"],
        ...
        with gr.Row(
            ...
            with gr.Column() as audio_col_5:
                ...
                with gr.Row(
                    ...
                    send_to_repaint_btn_5 = gr.Button(
                ...
                with gr.Accordion(
                    t("results.details_accordion"),
                    open=False,
                    visible=True,
                ) as details_accordion_5:
            ...
            with gr.Column() as audio_col_6:
                ...
                with gr.Row(
                    ...
                    send_to_repaint_btn_6 = gr.Button(
                        t("results.send_to_repaint_btn"),
                        variant="secondary",
                        size="sm",
                        scale=1,
            ...
            with gr.Column() as audio_col_7:
                ...
                with gr.Row(
                    ...
                    send_to_repaint_btn_7 = gr.Button(
                        t("results.send_to_repaint_btn"),
                        variant="secondary",
                        size="sm",
                        scale=1,
            ...
            with gr.Column() as audio_col_8:
                ...
                with gr.Row(
                    ...
                    send_to_repaint_btn_8 = gr.Button(
                        t("results.send_to_repaint_btn"),
                        variant="secondary",
                        size="sm",
                        scale=1,
        ...
        # Hidden in the simplified Synapse UI.
        # =====================================================================
        ...
        # =====================================================================
        # Generation Files / Details
        # =====================================================================

        with gr.Accordion(
            t(
                "results.batch_results_title"
            ),
            open=True,
        ):
    ...
    return {
        # Synapse Composer state
        "composer_metadata_state": composer_metadata_state,
